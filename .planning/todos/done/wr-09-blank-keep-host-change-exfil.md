...
**RESOLVED 2026-07-14 (Rob, live session):** Option 2 — blank-keep stays allowed
for port/TLS-mode/label edits; changing the HOST requires re-entering the
password. Locked into Phase 06.1 CONTEXT.md (WR-09 posture) and implemented as
part of Phase 06.1 (multi-SMTP). D-07/D-08 amended accordingly by that phase.
